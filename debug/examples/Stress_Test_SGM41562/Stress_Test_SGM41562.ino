 ...
 * @LastEditTime: 2024-07-11 14:07:20
 * @License: GPL 3.0
 */
...
void setup()
{
    ...
    // SGM41562->IIC_Write_Device_State(SGM41562->Arduino_IIC_Power::Device::POWER_DEVICE_PCB_OTP_MODE,
    //                                 SGM41562->Ardu  ino_IIC_Power::Device_State::POWER_DEVICE_OFF);
