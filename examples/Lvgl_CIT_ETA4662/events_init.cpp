 ...
 * @LastEditTime: 2024-06-18 11:39:54
 * @License: GPL 3.0
 */
#include "custom.h"
...
static void Home_list_1_item0_event_handler(lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ...
        CIT_UI.Window_Current_State = CIT_UI.Window_Current_State::Window_LCD_Backlight_Test;
...
static void Home_list_1_item2_event_handler(lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ...
        CIT_UI.Window_Current_State = CIT_UI.Window_Current_State::Window_Touch_Test;
        CIT_UI.Window_Initialization_Flag = false;
        break;
    }
    default:
...
static void Home_list_1_item3_event_handler(lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ...
        CIT_UI.Window_Current_State = CIT_UI.Window_Current_State::Window_Power_Test;
        CIT_UI.Window_Initialization_Flag = false;
        break;
    }
    default:
...
static void Home_list_1_item4_event_handler(lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ...
        CIT_UI.Window_Current_State = CIT_UI.Window_Current_State::Window_BREATHING_LIGHT_Test;
        CIT_UI.Window_Initialization_Flag = false;
        break;
    }
    default:
...
static void Home_list_1_item6_event_handler(lv_event_t *e)
{
    lv_event_code_t code = lv_event_get_code(e);
    ...
    case LV_EVENT_CLICKED:
    {
        CIT_UI.Window_Current_State = CIT_UI.Window_Current_State::Window_IMU_Test;
        CIT_UI.Window_Initialization_Flag = false;
...
void events_init_Home(lv_ui *ui)
{
    ...
    lv_obj_add_event_cb(ui->Home_list_1_item6, Home_list_1_item6_event_handler, LV_EVENT_ALL, NULL);
}
...
static void Test_event_handler(lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        case LV_DIR_LEFT:
        {
            ...
            if (CIT_UI.Window_WIFI_STA_Test_State == false)
            {
                if (d->prev_scr == NULL && (d->scr_to_load == NULL || d->scr_to_load == act_scr))
                {
...
static void Test_btnm_1_event_handler(lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ...
        case 0:
        {
            switch (CIT_UI.Window_Current_State)
            {
            case CIT_UI.Window_Current_State::Window_LCD_Backlight_Test:
                CIT_UI.Window_LCD_Backlight_Test_Result = CIT_UI.Window_Test_Result::Test_Pass;
                break;
            case CIT_UI.Window_Current_State::Window_LCD_Display_Color_Test:
                CIT_UI.Window_LCD_Display_Color_Test_Result = CIT_UI.Window_Test_Result::Test_Pass;
                break;
            case CIT_UI.Window_Current_State::Window_Touch_Test:
                CIT_UI.Window_Touch_Test_Result = CIT_UI.Window_Test_Result::Test_Pass;
                break;
            case CIT_UI.Window_Current_State::Window_Power_Test:
            ...
            case CIT_UI.Window_Current_State::Window_BREATHING_LIGHT_Test:
                ...
                CIT_UI.Window_BREATHING_LIGHT_Test_Result = CIT_UI.Window_Test_Result::Test_Pass;
                break;
            case CIT_UI.Window_Current_State::Window_WIFI_STA_Test:
        ...
        case 1:
        {
            ...
            {
            case CIT_UI.Window_Current_State::Window_LCD_Backlight_Test:
                CIT_UI.Window_LCD_Backlight_Test_Result = CIT_UI.Window_Test_Result::Test_Fail;
                break;
            case CIT_UI.Window_Current_State::Window_LCD_Display_Color_Test:
                CIT_UI.Window_LCD_Display_Color_Test_Result = CIT_UI.Window_Test_Result::Test_Fail;
                break;
            case CIT_UI.Window_Current_State::Window_Touch_Test:
                CIT_UI.Window_Touch_Test_Result = CIT_UI.Window_Test_Result::Test_Fail;
                break;
            case CIT_UI.Window_Current_State::Window_Power_Test:
            ...
            case CIT_UI.Window_Current_State::Window_BREATHING_LIGHT_Test:
                ...
                CIT_UI.Window_BREATHING_LIGHT_Test_Result = CIT_UI.Window_Test_Result::Test_Fail;
                break;
            case CIT_UI.Window_Current_State::Window_WIFI_STA_Test:
...
void events_init_Test(lv_ui *ui)
{
    ...
    if (CIT_UI.Window_Current_State != CIT_UI.Window_Current_State::Window_IMU_Test)
    {
