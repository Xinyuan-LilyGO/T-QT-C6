 ...
 * @LastEditTime: 2024-03-25 14:04:27
 * @License: GPL 3.0
 */
...
void setup_scr_Home(lv_ui *ui)
{
    ...
    switch (CIT_UI.Window_IMU_Test_Result)
    {
    case CIT_UI.Window_Test_Result::Test_NULL:
        ui->Home_list_1_item6 = lv_list_add_btn(ui->Home_list_1, LV_SYMBOL_RIGHT, "7.IMU test");
        break;
    case CIT_UI.Window_Test_Result::Test_Pass:
        ui->Home_list_1_item6 = lv_list_add_btn(ui->Home_list_1, LV_SYMBOL_RIGHT, "7.IMU test");
        break;
    ...
    lv_obj_add_style(ui->Home_list_1_item6, &style_Home_list_1_extra_btns_main_default, LV_PART_MAIN | LV_STATE_DEFAULT);
